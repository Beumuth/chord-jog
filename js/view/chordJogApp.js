const ChordJogApp = ((ObjectBuilder) => ObjectBuilder
    .fromExisting({
        Builder: {
...
// const ChordJogApp = Builder.Object
//     .fromScratch()
//     .withFields({Style: {stroke: { width: 1 } }})
//     .withMutation((chordJogApp) =>
//         chordJogApp.Style.stroke.halfWidth = chordJogApp.Style.stroke.width * .5)
//     .withFields({
//         Geometry: {
//             distance2: (a, b) =>
//                 Math.pow(a[0] - b[0], 2) +
...
//     .withFields({
//         SVG:})
//     .withFields({Strings: {count: 6}})
//     .withMutation(chordJogApp =>
//         chordJogApp.Strings.all = _.range(1, this.Strings.count+1))
//     .withFields({
//         Fingers: {
//             thumb: {
//                 name: "thumb",
...
//                 })}}})
//     .withMutation(chordJogApp => {
//         chordJogApp.Frets.fingerless = [chordJogApp.Frets.dead, chordJogApp.Frets.open];
//         chordJogApp.Frets.fingerful = _.range(chordJogApp.Frets.first, chordJogApp.Frets.last);
//         chordJogApp.Frets.roots = chordJogApp.Frets.fingerful.slice(0, chordJogApp.Frets.maxRoot)
//         chordJogApp.Frets.all = chordJogApp.Frets.fingerless.concat(chordJogApp.Frets.fingerful);
//         chordJogApp.Frets.isFingerless = chordJogApp.Frets.fingerless.includes;
//         chordJogApp.Frets.isFingerful = chordJogApp.Frets.fingerful.includes;
//         chordJogApp.Frets.Relative.all = _.range(
//                 chordJogApp.Frets.Relative.root,
//             chordJogApp.Frets.Relative.max+1);
//         chordJogApp.Frets.Relative.count = chordJogApp.Frets.Relative.all.length;})
//     .withFields({
//         StringActions: {
//             unsounded: " ",
//             open: "o",
...
//                 finger: finger })}})
//     .withMutation((chordJogApp) => {
//         chordJogApp.StringActions.deadened = (finger) => ({
//             fret: chordJogApp.Frets.dead,
//             finger: finger });
//         chordJogApp.StringActions.fromString = (string) =>
//             string === chordJogApp.StringActions.unsounded ?
//                 chordJogApp.StringActions.unsounded :
//                 string === chordJogApp.StringActions.open ?
//                     chordJogApp.StringActions.open :
//                     string.charAt(0) === chordJogApp.Frets.dead ?
//                         chordJogApp.StringActions.deadened(string.charAt(2)) :
//                         chordJogApp.StringActions.fretFinger(
//                             Number.parseInt(string.charAt(0)),
//                             string.charAt(2)),
//         chordJogApp.StringActions.toString = (stringAction) =>
//                 stringAction === chordJogApp.StringActions.unsounded ?
//                     chordJogApp.StringActions.unsounded :
//                     stringAction === chordJogApp.StringActions.open ?
//                         chordJogApp.StringActions.open :
